<form action="download-project" max-attempts="<?= ceil(Arsh\Core\Folder::size('.') / 26214400) /* 25MB */ ?>">
    ...
    <div class="row align-items-center text-muted">
        ...
        <div class="col-9 col-md-10">
            <?= trim(Arsh\Core\ENV::root() ?: Arsh\Core\ENV::site(), '/') ?>
        ...
        <div class="offset-3 col-9 offset-md-2 col-md-10">
            <div class="form-check py-2">
                <label class="form-check-label text-danger" for="actions-frequently-download--delete" data-toggle="tooltip" data-placement="left" title="Be careful!">
                    ...
                    And delete it from source: <span class="nowrap"><?= Arsh\Core\ENV::url() ?><span>
                </label>
            </div>
        </div>
    </div>
